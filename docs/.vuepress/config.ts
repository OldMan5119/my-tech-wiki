...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
        ...
        logo: '/img/logo_bg.jpeg', // 导航栏logo
        repo: '', // 导航栏右侧生成Github链接
        searchMaxSuggestions: 10, // 搜索结果显示最大数
        lastUpdated: '', // 开启更新时间，并配置前缀文字   string | boolean (取值为git提交时间)
        docsDir: 'docs', // 编辑的文件夹
        ...
        footer: {
            ...
            copyrightInfo:
                'gaxi.shi | <a href="http://beian.miit.gov.cn/" target="_blank">京ICP备20250820号</a> | <img src="/img/beian.png" style="width: 15px; margin-bottom: -3px;" /> <a href="https://beian.mps.gov.cn/#/query/webSearch?code=45142202000030" rel="noreferrer" target="_blank">京公网安备1102202000030</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
        },
