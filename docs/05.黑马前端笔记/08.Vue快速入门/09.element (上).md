---
title: element (上)
date: 2025-08-22 22:25:47
permalink: /pages/97525c/
categories:
  - 黑马前端笔记
  - 12天快速入门Vue
tags:
...
![image-20220617072834031](/assets4620975813/image-20220617072834031.png)

首页

![image-20220617060021359](/assets4620975813/image-20220617060021359.png)

面经管理 - 列表展示

![image-20220617060123478](/assets4620975813/image-20220617060123478.png)

面经管理 - 预览效果

![image-20220617060222666](/assets4620975813/image-20220617060222666.png)

面经管理 -删除功能

![image-20220617060211868](/assets4620975813/image-20220617060211868.png)

面经管理 - 添加功能

![image-20220617060301375](/assets4620975813/image-20220617060301375.png)

面经管理 - 修改功能

![image-20220617060316985](/assets4620975813/image-20220617060316985.png)
...
![image-20220617060702862](/assets4620975813/image-20220617060702862.png)



![image-20220617060757090](/assets4620975813/image-20220617060757090.png)

* 选择vue版本

![image-20220617060818457](/assets4620975813/image-20220617060818457.png)
...
![image-20220617060854885](/assets4620975813/image-20220617060854885.png)
...
![image-20220617061002551](/assets4620975813/image-20220617061002551.png)
...
![image-20220617061022684](/assets4620975813/image-20220617061022684.png)





* 保存代码的时候：进行校验（VSC：自动保存习惯关闭！）

![image-20220617061038189](/assets4620975813/image-20220617061038189.png)
...
![image-20220617061103526](/assets4620975813/image-20220617061103526.png)
...
![image-20220617061127960](/assets4620975813/image-20220617061127960.png)
...
![image-20211005210420736](/assets4620975813/image-20211005210420736.png)
...
![image-20211005211307229](/assets4620975813/image-20211005211307229.png)
...
![image-20220617164619682](/assets4620975813/image-20220617164619682.png)
...
```jsx
// 如何理解：以前，我们之间用token封装的相关的方法，因为现在数据都在vuex,需要把数据集中在vuex管理，
//   1、获取token从vuex获取
//   2、设置token也是去vuex；
export default {
  namespaced: true,
...
`router/index.js`：没有token 且 访问的不是 登录页，就直接拦截到登录
      ...
      <el-header>
        <div class="user">
          <el-avatar
            ...
            src="xxx"
          ></el-avatar>
          <el-link :underline="false">xxx</el-link>
        </div>
        <div class="logout">
...
![image-20220617140402138](/assets4620975813/image-20220617140402138.png)
