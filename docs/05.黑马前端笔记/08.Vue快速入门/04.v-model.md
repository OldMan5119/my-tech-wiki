---
title: v-model
date: 2025-08-22 22:10:24
permalink: /pages/714399/
categories:
  - 黑马前端笔记
  - 12天快速入门Vue
tags:
...
![image-20210115120631003](/assets59778526601/image-20210115120631003.png)

- 父传子给子组件传递value属性和input事件

![image-20210115120702759](/assets59778526601/image-20210115120702759.png)
...
![image-20220608080633145](/assets59778526601/image-20220608080633145.png)
...
![image-20220608072329277](/assets59778526601/image-20220608072329277.png)
...
![image-20220610073238230](/assets59778526601/image-20220610073238230.png)
...
![image-20220610073545654](/assets59778526601/image-20220610073545654.png)
...
2. 子组件MyTag.vue接收渲染，子组件是否能直接修改数据？
  ...
  <table class="my-table">
    ...
    <tbody>
      ...
      <tr v-for="(item, index) in list" :key="item.id">
        <slot name="td" :index="index" :item="item"></slot>
      </tr>
...
<template>
  <div class="table-case">
    ...
    <MyTable :list="goods">
      ...
      <template #td="{ index, item }">
        <td>{{ index + 1 }}</td>
        <td>{{ item.name }}</td>
        <td>
          <!-- 应该是允许子组件的直接更新标签内容，这个标签内容没有什么大的问题 -->
          <!-- :value 和 @input  -->
