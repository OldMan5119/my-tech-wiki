---
title: 生命周期
date: 2025-08-22 22:17:41
permalink: /pages/67e0e4/
categories:
  - 黑马前端笔记
  - 12天快速入门Vue
tags:
...
![image-20210111193143574](/assets5790132486/image-20210111193143574.png)
...
![image-20210111193357762](/assets5790132486/image-20210111193357762.png)
...
![image-20210512095742920](/assets5790132486/image-20210512095742920.png)



> 目标: 路径和组件的映射关系

![image-20210512095825389](/assets5790132486/image-20210512095825389.png)
...
![image-20210424215930981](/assets5790132486/image-20210424215930981.png)
...
![image-20210602114435336](/assets5790132486/image-20210602114435336.png)
...
3. 导航跳转, 传值给Friend.vue组件
   ...
   <router-link to="/friend/小智">朋友-小智</router-link>
...
1. 创建NotFound页面
   ...
   ```vue
   <template>
     <img src="..//assets5790132486/404.png" alt="">
   </template>
...
![image-20220613011210143](/assets5790132486/image-20220613011210143.png)



![image-20220613012452936](/assets5790132486/image-20220613012452936.png)

![image-20220613110855088](/assets5790132486/image-20220613110855088.png)
...
配置自动导入： https://www.cnblogs.com/terrysu/p/9329570.html

目标: 在现有的一级路由下, 再嵌套二级路由

从《教学资料》 views 目录中， CV 四个二级路由组件， 到我们的目录中

![image-20220613015146888](/assets5790132486/image-20220613015146888.png)
...
```txt
请求地址: https://mock.boxuegu.com/mock/3083/articles/:1
请求方式: get
...
![image-20220613022957478](/assets5790132486/image-20220613022957478.png)
