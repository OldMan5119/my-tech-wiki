---
title: vue脚手架_基础API
date: 2021-05-14 09:35:16
permalink: /pages/768f49/
categories:
  - 黑马前端笔记
  - Vue2
tags:
...
2. 打开谷歌浏览器-扩展程序-开发者模式打开-把文件夹拖进来就安装完毕
   ...
   ![安装谷歌助手插件](images74873596085/安装谷歌助手插件.gif)
...
![安装vue_devtools插件到谷歌浏览器](images74873596085/安装vue_devtools插件到谷歌浏览器.gif)

### vscode-插件补充

vue文件代码高亮插件-vscode中安装

![image-20210212192713936](images74873596085/image-20210212192713936.png)

代码提示插件-vscode中安装

![image-20210304223236080](images74873596085/image-20210304223236080.png)
...
![image-20210317180201113](images74873596085/image-20210317180201113.png)
...
![image-20210317180240323](images74873596085/image-20210317180240323.png)

市场上90%工作都要求会vue, 会vue拿高薪, 甚至java或测试都要学点vue

![image-20210317180255055](images74873596085/image-20210317180255055.png)

### 1.1_Vue是什么

logo镇楼

![Vue](images74873596085/VUE-logo.png)
...
![image-20210314200521109](images74873596085/image-20210314200521109.png)

Vue渐进式: Vue从基础开始, 会循序渐进向前学习, 如下知识点可能你现在不明白, 但是学完整个vue回过头来看, 会很有帮助

![](images74873596085/渐进式-1613206784433.png)
...
![image-20210111215624065](images74873596085/image-20210111215624065.png)

![image-20210212141558460](images74873596085/image-20210212141558460.png)

### 1.2_Vue学习的方式

+ 传统开发模式：基于html/css/js文件开发vue

  ![image-20210228083641377](images74873596085/image-20210228083641377.png)

+ 工程化开发方式：在webpack环境中开发vue，这是最推荐, 企业常用的方式

  ![image-20210228083746746](images74873596085/image-20210228083746746.png)
...
![1586936282638](images74873596085/1586936282638.png)
...
![image-20210116230221236](images74873596085/image-20210116230221236.png)

​	 	选择用什么方式下载脚手架项目需要的依赖包![Snipaste_2021-03-26_15-24-14](images74873596085/Snipaste_2021-03-26_15-24-14.png)

3. 回车等待生成项目文件夹+文件+下载必须的第三方包们

![image-20210212174314768](images74873596085/image-20210212174314768.png)
...
![image-20210116231815543](images74873596085/image-20210116231815543.png)

打开浏览器输入上述地址

![image-20210116233035582](images74873596085/image-20210116233035582.png)
...
![image-20210317201811310](images74873596085/image-20210317201811310.png)
...
![image-20210326165406694](images74873596085/image-20210326165406694.png)

观察发现, 终端和页面都报错了

==记住以后见到这样子的错误, 证明你的代码不严谨==

![image-20210326165544865](images74873596085/image-20210326165544865.png)

![image-20210326165606191](images74873596085/image-20210326165606191.png)

方式1: 手动解决掉错误, 以后项目中会讲如何自动解决

方式2: 暂时关闭eslint检查(因为现在主要精力在学习Vue语法上), 在vue.config.js中配置后重启服务

![image-20210511112152702](images74873596085/image-20210511112152702.png)
...
![](images74873596085/MVVM.png)

**1. 在vue中，不推荐直接手动操作DOM！！！**  

**2. 在vue中，通过数据驱动视图，不要在想着怎么操作DOM，而是想着如何操作数据！！**(思想转变)

![](images74873596085/双向数据绑定.png)
...
![练习1_翻转世界](images74873596085/2.8.0_练习_翻转世界.gif)
...
![案例_折叠面板](images74873596085/案例_折叠面板.gif)
...
![练习2_改变数组顺序_影响vfor指令的标签](images74873596085/2.8.1_练习_帅哥美女走一走.gif)
...
![练习3_点击生成_点击删除](images74873596085/2.8.2_练习_人生加加减减.gif)
...
![3.0_案例_购物车删除_干净了还有提示](images74873596085/3.0_案例_购物车删除_干净了还有提示.gif)
...
![Day01_作业_买水果](images74873596085/Day01_作业_买水果.gif)
...
![4.9.1_练习_选择喜欢的栏目](images74873596085/4.9.1_练习_选择喜欢的栏目.gif)
