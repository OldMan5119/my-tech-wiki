...
![1576208177581](/image50493754616/123.png)
...
![1576483576664](/image50493754616/1576483576664.png)
...
<head>
    ...
    <style>
        ...
        li:nth-child(1){
            /*border-image: url("images74873596085/border.jpg") 167/20px round;*/
            border-image-source: url("images/border.jpg");
            border-image-slice: 167 167 167 167;
            border-image-width: 20px;
            /*环绕  是完整的使用切割后的图片进行平铺*/                    
...
![1576664444951](/image50493754616/1576664444951.png)
